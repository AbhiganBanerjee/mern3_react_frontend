...
const GetAllGames = ()=>{
    ...
    useEffect(()=>{
        //Make the API call
        fetch("https://mern3-node-mongo.onrender.com/fetchGames")
        .then((res)=>{
            return res.json();
        }).then((datas)=>{
            setGames(datas);
    ...
    const handleDelete = ()=>{
        ...
        fetch(`https://mern3-node-mongo.onrender.com/deleteGame?name=${games[idx].name}`,{
            method: 'DELETE',
            headers: {
    ...
    return(
        <div className="container-fluid">
            <header className="m-1 p-1 text-center" style={{border:"2px solid #101820",backgroundColor:"#FEE715",color:"#101820"}}>
                <h4 className="fs-7 font-monospace fw-bold fst-italic">
                    <span className="bi bi-steam"></span> All Games Related Information are Displayed Here
                </h4>
            </header>
            <Container component="main" maxWidth="xs">
                {/* Start the Card */}
                <Card style={{backgroundColor: isTheme ? "#FEE715" : "#101820",color: isTheme ? "#101820" : "#FEE715"}} className="mt-3 mb-2" elevation={4} >
                    {/* Create the Card Header */}
                    <CardHeader 
                        avatar = {
                            <Avatar 
                                style={{border:isTheme ? "2px solid #101820" : "2px solid #FEE715",borderRadius:"50%"}} 
                    ...
                    <CardContent className="row card-body">
                        <Typography className="font-monospace mb-1">
                            Price: <b className="font-monospace">{games[idx].price}</b><br/>
                            Publisher: <b className="font-monospace">{games[idx].publisher}</b><br/> 
                        </Typography>
                        ...
                        <div className="col-10 d-flex flex-column">
                            ...
                            <CardMedia 
                                ...
                                style={{border:isTheme ? "4px solid #101820" : "4px solid #FEE715"}}
                                height="340"
                            />
                            <b className="font-monospace text-center fst-italic" id="status" style={{display:"none",color: isTheme ? "#101820" : "#FEE715"}}></b>
                        </div>
                        <CardActions className="col-1 d-flex justify-content-center flex-column">
                    ...
                    {/* Card Footer */}
                    <div className="row" style={{borderTop: isTheme ? "2px solid #101820" : "2px solid #FEE715"}}>
